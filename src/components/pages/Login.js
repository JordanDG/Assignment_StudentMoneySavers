...
export default function Login() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            setError('');
            setLoading(true);
            await login(emailRef.current.value, passwordRef.current.value).then(navigate('/dashboard'));
  ...
  return (
    <>  
        <MainContainer>
            ...
            <Signupmain>
                <SignupmainTitle>Login:</SignupmainTitle>
                ...
                <SignupmainForm onSubmit={handleSubmit}>
                    ...
                    <ForgotPasswordDiv>
                        <ForgotPasswordText to="/forgotpassword">Forgot password? Click Here</ForgotPasswordText>
                    </ForgotPasswordDiv>
                    <SignUpSubmit type="submit" disabled={loading}>Log in</SignUpSubmit>
                </SignupmainForm>
                <GoBackHome to="/">Go Back</GoBackHome>
                <SignupLoginRedirect>Need an account? <Link to="/signup">Sign up</Link></SignupLoginRedirect>
            </Signupmain>
        </MainContainer>
    </>
  );
