...
export default function ForgotPassword() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            alert('Success! - Check your email inbox for further instructions.');
    ...
    return (
        <>
            ...
            <Signupmain>
                <SignupmainTitle>Forgot Password:</SignupmainTitle>
                ...
                <SignupmainForm onSubmit={handleSubmit}>
                    ...
                    <SignUpSubmit type="submit" disabled={loading}>Submit</SignUpSubmit>
                </SignupmainForm>
                <GoBackHome to="/login">Go Back</GoBackHome>
